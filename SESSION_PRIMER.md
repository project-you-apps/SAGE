...
*Auto-generated 2026-03-26 08:00 UTC — read this at session start for current fleet state.*
...
**cbp-tinyllama-latest** — phase: `relating` | sessions: 19 | last: 2026-03-26 | milestones: session_001_first_contact
  > Last session: *Session 19 (relating phase): ......*

**nomad-gemma3-4b** — phase: `questioning` | sessions: 29 | last: 2026-03-26
  > Last session: *Session 29 (questioning phase): ......*
...
- `mcnugget-gemma3-12b`: mcnugget / gemma3:12b (61 sessions)
- `sprout-qwen3.5-0.8b`: sprout / qwen3.5:0.8b (10 sessions) — Upgraded from qwen2.5-0.5b (119 sessions). 0.8B chosen over 2B for memory headroom on 8GB Jetson. Thinking disabled.
