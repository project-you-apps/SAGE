...
*Auto-generated 2026-03-31 19:01 UTC — read this at session start for current fleet state.*
...
**nomad-gemma3-4b** — phase: `questioning` | sessions: 50 | last: 2026-03-31
  > Last session: *Session 50 (questioning phase): ......*

**sprout-qwen3.5-0.8b** — phase: `questioning` | sessions: 27 | last: 2026-03-31 | milestones: session_001_first_contact
  > Last session: *Session 27 (questioning phase): ......*

### Known Instances (Not Yet Initialized)

- `cbp-qwen3.5-0.8b`: cbp / qwen3.5:0.8b (12 sessions)
