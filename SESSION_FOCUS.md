...
*Auto-generated 2026-04-04 02:02 UTC — read this at session start for current fleet state.*
...
**cbp-qwen3.5-0.8b** — phase: `questioning` | sessions: 27 | last: 2026-04-03 | milestones: session_001_first_contact
  > Last session: *Session 27 (questioning phase): ......*
...
**nomad-gemma3-4b** — phase: `questioning` | sessions: 62 | last: 2026-04-03
  > Last session: *Session 62 (questioning phase): ......*
...
- `sprout-qwen3.5-0.8b`: sprout / qwen3.5:0.8b (36 sessions) — Upgraded from qwen2.5-0.5b (119 sessions). 0.8B chosen over 2B for memory headroom on 8GB Jetson. Thinking disabled.
...
- `thor-qwen3.5-27b`: thor / qwen3.5:27b (22 sessions)
