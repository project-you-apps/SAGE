...
*Auto-generated 2026-03-29 07:05 UTC — read this at session start for current fleet state.*
...
**sprout-qwen3.5-0.8b** — phase: `relating` | sessions: 19 | last: 2026-03-29 | milestones: session_001_first_contact
  > Last session: *Session 19 (relating phase): ......*

### Known Instances (Not Yet Initialized)

- `cbp-qwen3.5-0.8b`: cbp / qwen3.5:0.8b (5 sessions)
