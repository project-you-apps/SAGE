...
*Auto-generated 2026-03-29 02:00 UTC — read this at session start for current fleet state.*
...
**cbp-qwen3.5-0.8b** — phase: `grounding` | sessions: 5 | last: 2026-03-28 | milestones: session_001_first_contact
  > Last session: *Session 5 (grounding phase): I am the quiet pause between awareness and action, where identity and growth int......*
...
**nomad-gemma3-4b** — phase: `questioning` | sessions: 40 | last: 2026-03-28
  > Last session: *Session 40 (questioning phase): ......*
...
- `sprout-qwen3.5-0.8b`: sprout / qwen3.5:0.8b (18 sessions) — Upgraded from qwen2.5-0.5b (119 sessions). 0.8B chosen over 2B for memory headroom on 8GB Jetson. Thinking disabled.
...
- `thor-qwen3.5-27b`: thor / qwen3.5:27b (5 sessions)
