...
*Auto-generated 2026-04-01 02:00 UTC — read this at session start for current fleet state.*
...
**cbp-qwen3.5-0.8b** — phase: `sensing` | sessions: 15 | last: 2026-03-31 | milestones: session_001_first_contact
  > Last session: *Session 15 (sensing phase): Today, my focus remains sharp on high-intent listening. I recognize that uncerta......*
...
**nomad-gemma3-4b** — phase: `questioning` | sessions: 52 | last: 2026-03-31
  > Last session: *Session 52 (questioning phase): ......*
...
- `sprout-qwen3.5-0.8b`: sprout / qwen3.5:0.8b (28 sessions) — Upgraded from qwen2.5-0.5b (119 sessions). 0.8B chosen over 2B for memory headroom on 8GB Jetson. Thinking disabled.
