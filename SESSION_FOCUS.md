...
*Auto-generated 2026-03-29 08:00 UTC — read this at session start for current fleet state.*
...
**cbp-qwen3.5-0.8b** — phase: `sensing` | sessions: 6 | last: 2026-03-29 | milestones: session_001_first_contact
...
**nomad-gemma3-4b** — phase: `questioning` | sessions: 41 | last: 2026-03-29
  > Last session: *Session 41 (questioning phase): ......*
...
- `sprout-qwen3.5-0.8b`: sprout / qwen3.5:0.8b (19 sessions) — Upgraded from qwen2.5-0.5b (119 sessions). 0.8B chosen over 2B for memory headroom on 8GB Jetson. Thinking disabled.
...
- `thor-qwen3.5-27b`: thor / qwen3.5:27b (6 sessions)
