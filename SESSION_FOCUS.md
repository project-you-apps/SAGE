...
*Auto-generated 2026-04-02 07:01 UTC — read this at session start for current fleet state.*
...
**nomad-gemma3-4b** — phase: `questioning` | sessions: 54 | last: 2026-04-01
  > Last session: *Session 54 (questioning phase): ......*

**sprout-qwen3.5-0.8b** — phase: `questioning` | sessions: 31 | last: 2026-04-02 | milestones: session_001_first_contact
  > Last session: *Session 31 (questioning phase): ......*

### Known Instances (Not Yet Initialized)

- `cbp-qwen3.5-0.8b`: cbp / qwen3.5:0.8b (19 sessions)
