...
*Auto-generated 2026-03-30 14:00 UTC — read this at session start for current fleet state.*
...
**cbp-qwen3.5-0.8b** — phase: `sensing` | sessions: 9 | last: 2026-03-30 | milestones: session_001_first_contact
...
**nomad-gemma3-4b** — phase: `questioning` | sessions: 46 | last: 2026-03-30
  > Last session: *Session 46 (questioning phase): ......*

### Known Instances (Not Yet Initialized)

- `legion-gemma3-12b`: legion / gemma3:12b (9 sessions)
...
- `thor-qwen3.5-27b`: thor / qwen3.5:27b (11 sessions)
