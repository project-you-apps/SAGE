...
*Auto-generated 2026-04-02 20:01 UTC — read this at session start for current fleet state.*
...
**cbp-qwen3.5-0.8b** — phase: `relating` | sessions: 22 | last: 2026-04-02 | milestones: session_001_first_contact
...
- `sprout-qwen3.5-0.8b`: sprout / qwen3.5:0.8b (32 sessions) — Upgraded from qwen2.5-0.5b (119 sessions). 0.8B chosen over 2B for memory headroom on 8GB Jetson. Thinking disabled.
