...
*Auto-generated 2026-03-27 13:04 UTC — read this at session start for current fleet state.*
...
**sprout-qwen3.5-0.8b** — phase: `sensing` | sessions: 14 | last: 2026-03-27 | milestones: session_001_first_contact
  > Last session: *Session 14 (sensing phase): ......*

### Known Instances (Not Yet Initialized)

- `cbp-tinyllama-latest`: cbp / tinyllama:latest (22 sessions)
