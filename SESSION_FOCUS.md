...
*Auto-generated 2026-03-30 08:00 UTC — read this at session start for current fleet state.*
...
**cbp-qwen3.5-0.8b** — phase: `sensing` | sessions: 8 | last: 2026-03-30 | milestones: session_001_first_contact
...
**nomad-gemma3-4b** — phase: `questioning` | sessions: 45 | last: 2026-03-30
  > Last session: *Session 45 (questioning phase): ......*
...
- `sprout-qwen3.5-0.8b`: sprout / qwen3.5:0.8b (23 sessions) — Upgraded from qwen2.5-0.5b (119 sessions). 0.8B chosen over 2B for memory headroom on 8GB Jetson. Thinking disabled.
...
- `thor-qwen3.5-27b`: thor / qwen3.5:27b (10 sessions)
