...
*Auto-generated 2026-04-03 01:01 UTC — read this at session start for current fleet state.*
...
**nomad-gemma3-4b** — phase: `questioning` | sessions: 57 | last: 2026-04-02
  > Last session: *Session 57 (questioning phase): ......*

**sprout-qwen3.5-0.8b** — phase: `questioning` | sessions: 33 | last: 2026-04-02 | milestones: session_001_first_contact
  > Last session: *Session 33 (questioning phase): ......*

### Known Instances (Not Yet Initialized)

- `cbp-qwen3.5-0.8b`: cbp / qwen3.5:0.8b (22 sessions)
