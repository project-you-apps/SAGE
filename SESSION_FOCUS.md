...
*Auto-generated 2026-04-02 19:01 UTC — read this at session start for current fleet state.*
...
**sprout-qwen3.5-0.8b** — phase: `questioning` | sessions: 32 | last: 2026-04-02 | milestones: session_001_first_contact
  > Last session: *Session 32 (questioning phase): ......*

### Known Instances (Not Yet Initialized)

- `cbp-qwen3.5-0.8b`: cbp / qwen3.5:0.8b (21 sessions)
