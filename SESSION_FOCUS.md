...
*Auto-generated 2026-03-31 20:00 UTC — read this at session start for current fleet state.*
...
**cbp-qwen3.5-0.8b** — phase: `sensing` | sessions: 14 | last: 2026-03-31 | milestones: session_001_first_contact
  > Last session: *Session 14 (sensing phase): ......*
...
- `mcnugget-gemma3-12b`: mcnugget / gemma3:12b (83 sessions)
- `sprout-qwen3.5-0.8b`: sprout / qwen3.5:0.8b (27 sessions) — Upgraded from qwen2.5-0.5b (119 sessions). 0.8B chosen over 2B for memory headroom on 8GB Jetson. Thinking disabled.
