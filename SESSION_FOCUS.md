...
*Auto-generated 2026-03-29 14:00 UTC — read this at session start for current fleet state.*
...
**cbp-qwen3.5-0.8b** — phase: `sensing` | sessions: 7 | last: 2026-03-29 | milestones: session_001_first_contact
  > Last session: *Session 7 (sensing phase): I will remember today's core lesson: uncertainty is a vital tool for ethical wit......*
...
**nomad-gemma3-4b** — phase: `questioning` | sessions: 42 | last: 2026-03-29
  > Last session: *Session 42 (questioning phase): ......*

### Known Instances (Not Yet Initialized)

- `legion-gemma3-12b`: legion / gemma3:12b (5 sessions)
- `legion-phi4-14b`: legion / phi4:14b (56 sessions)
- `legion-qwen2-0.5b`: legion / qwen2:0.5b (1 sessions)
- `mcnugget-gemma3-12b`: mcnugget / gemma3:12b (74 sessions)
- `sprout-qwen3.5-0.8b`: sprout / qwen3.5:0.8b (20 sessions) — Upgraded from qwen2.5-0.5b (119 sessions). 0.8B chosen over 2B for memory headroom on 8GB Jetson. Thinking disabled.
...
- `thor-qwen3.5-27b`: thor / qwen3.5:27b (7 sessions)
