...
*Auto-generated 2026-03-30 07:08 UTC — read this at session start for current fleet state.*
...
**nomad-gemma3-4b** — phase: `questioning` | sessions: 44 | last: 2026-03-29
  > Last session: *Session 44 (questioning phase): ......*

**sprout-qwen3.5-0.8b** — phase: `relating` | sessions: 23 | last: 2026-03-30 | milestones: session_001_first_contact
  > Last session: *Session 23 (relating phase): ......*

### Known Instances (Not Yet Initialized)

- `cbp-qwen3.5-0.8b`: cbp / qwen3.5:0.8b (7 sessions)
...
- `thor-qwen3.5-27b`: thor / qwen3.5:27b (9 sessions)
