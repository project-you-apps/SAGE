...
*Auto-generated 2026-03-28 02:00 UTC — read this at session start for current fleet state.*
...
**cbp-tinyllama-latest** — phase: `relating` | sessions: 25 | last: 2026-03-27 | milestones: session_001_first_contact
...
- `mcnugget-gemma3-12b`: mcnugget / gemma3:12b (68 sessions)
- `sprout-qwen3.5-0.8b`: sprout / qwen3.5:0.8b (15 sessions) — Upgraded from qwen2.5-0.5b (119 sessions). 0.8B chosen over 2B for memory headroom on 8GB Jetson. Thinking disabled.
