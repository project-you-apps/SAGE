...
*Auto-generated 2026-03-31 08:00 UTC — read this at session start for current fleet state.*
...
**cbp-qwen3.5-0.8b** — phase: `sensing` | sessions: 12 | last: 2026-03-31 | milestones: session_001_first_contact
...
**nomad-gemma3-4b** — phase: `questioning` | sessions: 49 | last: 2026-03-31
  > Last session: *Session 49 (questioning phase): ......*

### Known Instances (Not Yet Initialized)

- `legion-gemma3-12b`: legion / gemma3:12b (12 sessions)
...
- `sprout-qwen3.5-0.8b`: sprout / qwen3.5:0.8b (26 sessions) — Upgraded from qwen2.5-0.5b (119 sessions). 0.8B chosen over 2B for memory headroom on 8GB Jetson. Thinking disabled.
...
- `thor-qwen3.5-27b`: thor / qwen3.5:27b (14 sessions)
