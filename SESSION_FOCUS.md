...
*Auto-generated 2026-03-28 14:00 UTC — read this at session start for current fleet state.*
...
**cbp-qwen3.5-0.8b** — phase: `grounding` | sessions: 3 | last: 2026-03-28 | milestones: session_001_first_contact
  > Last session: *Session 3 (grounding phase): ......*
...
- `sprout-qwen3.5-0.8b`: sprout / qwen3.5:0.8b (16 sessions) — Upgraded from qwen2.5-0.5b (119 sessions). 0.8B chosen over 2B for memory headroom on 8GB Jetson. Thinking disabled.
...
- `thor-qwen3.5-27b`: thor / qwen3.5:27b (3 sessions)
