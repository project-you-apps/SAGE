...
1. **The S152 §6 prediction takes a real hit at phrase level.** F_blink's five q=2 vivid named coinages (Margin, Rest, the Gasp, the long exhale, watch-the-dark) — the most quotable register in the rated set — got zero teacher pickup across eight subsequent sessions (S143–S150), while the perceptual register (S137) and static-glide (S143), coined in the same era, were relayed. Whatever selects for relay, it is not per-phrase quotability.
